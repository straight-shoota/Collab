(function() {
  ...
  Collab = (function() {
    ...
    Collab.prototype.mouse2D = new THREE.Vector3(0, 0, 0);

    Collab.prototype.inLoop = false;

    Collab.prototype.selected = false;

    function Collab() {}

    Collab.prototype.init = function(container) {
      var aspect;
    ...
    Collab.prototype.initScene = function() {};

    Collab.prototype.render = function() {
      return this.renderer.render(this.scene, this.camera);
    };

    Collab.prototype.update = function() {};

    Collab.prototype.startLoop = function() {
      this.inLoop = true;
      return this._loop();
    };

    Collab.prototype.stopLoop = function() {
      return this.inLoop = false;
    };

    Collab.prototype._loop = function() {
      var _this = this;
      this.update();
      this.render();
      if (this.inLoop) {
    ...
    Collab.prototype._mouseMove = function(event) {
    ...
    Collab.prototype._click = function(event) {};

    Collab.prototype._mouseDown = function(event) {
    ...
    Collab.prototype._mouseUp = function(event) {
      this.select(false);
      return this.positionOnPlane = null;
    };

    Collab.prototype.select = function(object) {
      if (object) {
